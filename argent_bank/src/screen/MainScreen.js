      ...
      <main>
        ...
        <section className="features">
          ...
          <div className="feature-item">
            <img src={chat_img} alt="Chat Icon" className="feature-icon" />
          ...
          <div className="feature-item">
            <img src={money_img} alt="Money Icon" className="feature-icon" />
          ...
          <div className="feature-item">
            <img src={security_img} alt="Security Icon" className="feature-icon" />
